...
#Libraries required for neural networks
...
#Removes unnecessary columns and separates the target value from the input features
...
#For a predetermined number of iterations, the data is split into training and testing data
#The trained model is used to predict outputs and the metrics precision, recall, and F1 are calculated
